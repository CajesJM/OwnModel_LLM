...
.header {
    ...
    color: #1e3c72;       /* dark blue for text contrast */
...
with gr.Blocks(css=custom_css, title="Cypher Tech") as demo:
    gr.HTML("""
        <div class="header">
            <h1>Cypher Tech</h1>
            <p>Your smart guide to TMC's vision, mission, and more — in English, Cebuano, or Tagalog</p>
        </div>
    """)
    ...
    gr.HTML("""
        <div class="footer">
            Powered by <strong>Cajes JM</strong> · Custom mini-LLM · Runs 100% offline
        </div>
    """)
